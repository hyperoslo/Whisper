...
class ViewController: UIViewController {
  ...
  func presentButtonDidPress(button: UIButton) {
    ...
    WhisperShowing.show(whisper: message, to: navigationController, action: .Present)
    WhisperShowing.hide(whisperFrom: navigationController, after: 3)
  }
  ...
  func showButtonDidPress(button: UIButton) {
    ...
    WhisperShowing.show(whisper: message, to: navigationController)
  }
  ...
  func presentNotificationDidPress(button: UIButton) {
    ...
    if let navigationController = navigationController {
      WhisperShowing.show(shout: announcement, to: navigationController, completion: {
  ...
  func showWhistleButtonDidPress(button: UIButton) {
    ...
    WhisperShowing.show(whistle: murmur)
  }
  ...
  func presentWhistleButtonDidPress(button: UIButton) {
    ...
    WhisperShowing.show(whistle: murmur, action: .Present)
  }
